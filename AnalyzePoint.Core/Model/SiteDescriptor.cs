...
namespace AnalyzePoint.Core.Model
{
  ...
  {
    public ObservableCollection<SiteContentDescriptor> Contents { get; protected set; }
    ...
    {
      Contents = new ObservableCollection<SiteContentDescriptor>();
      Contents.CollectionChanged += ContentsCollectionChanged;
    ...
    private void ContentsCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
    {
      if (e.Action == NotifyCollectionChangedAction.Add || e.Action == NotifyCollectionChangedAction.Replace)
      {
        ...
        {
          SiteContentDescriptor scd = item as SiteContentDescriptor;
          scd.ContainingSite = this;
        }
      }
    }
