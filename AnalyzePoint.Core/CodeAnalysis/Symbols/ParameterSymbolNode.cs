...
namespace AnalyzePoint.Core.CodeAnalysis.Symbols
{
  ...
  {
    public IParameterSymbol InnerSymbol
    {
      get { return (IParameterSymbol)base.InnerSymbol; }
    }

    internal ParameterSymbolNode(IParameterSymbol symbol, SymbolNode parent = null, IEnumerable<SymbolNode> children = null) : base(symbol, parent, children)
    {
      ;
    }
